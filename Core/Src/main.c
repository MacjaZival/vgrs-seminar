...
/* Definitions for userButtonQueue */
osMessageQueueId_t userButtonQueueHandle;
const osMessageQueueAttr_t userButtonQueue_attributes = {
  .name = "userButtonQueue"
};
